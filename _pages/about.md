...
* I am currently a <b>Scientist</b> (<b>Principal Investigator, Team Leader, PhD advisor</b>) at [Institute for Infocomm Research](https://www.a-star.edu.sg/i2r), Agency for Science, Technology and Research (A*STAR), Singapore, and a <b>Part-time Lecture</b> at [Nanyang Technological University (NTU), Singapore](https://www.ntu.edu.sg/Pages/home.aspx).
...
# Recent News
* I am homored to be recognised as the World's Top 2% Scientists. It is compiled by Stanford University based on the standardized citation indicators, which was publised in [PLOS Biology](https://journals.plos.org/plosbiology/article?id=10.1371/journal.pbio.3000918) and also avaiable online at [Mendeley Database](https://data.mendeley.com/datasets/btchxktzyw/2).
